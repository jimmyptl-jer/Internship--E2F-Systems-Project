...
const contactSchema = new mongoose.Schema({
  ...
  firstName: {
    type: String,
    required: 'Firstname is required' // It is required, and the message provides a custom error message if not provided.
  },
  // Define the 'lastName' field with the data type 'String'
  lastName: {
    type: String,
    required: 'Lastname is required' // It is required, and the message provides a custom error message if not provided.
  },
  // Define the 'email' field with the data type 'String'
  email: {
    type: String,
  },
  // Define the 'company' field with the data type 'String'
  company: {
    type: String,
  },
